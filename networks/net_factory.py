...
from networks.Unet1 import UNet_512
...
parser.add_argument(
    '--cfg', type=str, default=r'D:\xxu\code2\configs\swin_tiny_patch4_window7_224_lite.yaml', help='path to config file', )
parser.add_argument(
    "--opts",
...
parser.add_argument('--use_gva', type=int, default=1, help='Whether to use GVA module (1=Yes, 0=No)')
parser.add_argument('--use_afp', type=int, default=1,
                    help='Whether to use Adaptive Frequency Perturbation (1=Yes, 0=No)')
parser.add_argument('--use_cfl', type=int, default=1, help='Whether to use Consistency Frequency Loss (1=Yes, 0=No)')
parser.add_argument('--max_delta', type=float,
                    default=0.2, help='consistency_rampup')
parser.add_argument('--active_scale', type=float,
                    default=0.2, help='consistency_rampup')
parser.add_argument('--freq_cutoff', type=float,
                    default=0.01, help='consistency_rampup')
...
def net_factory(net_type="unet", in_chns=1, class_num=3):
    ...
    elif net_type == "unet512":
        net = UNet_512(n_channels=in_chns, n_classes=class_num).cuda()
